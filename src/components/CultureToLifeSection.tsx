      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <ScrollAnimationWrapper animation="scaleIn" delay={200}>
          <div className="relative flex justify-center items-center mb-12 sm:mb-20 min-h-[300px] sm:min-h-[500px]">
            {/* Circular dotted lines background */}
            <div className="absolute inset-0 flex justify-center items-center">
              <div className="relative w-[300px] h-[300px] sm:w-[600px] sm:h-[600px] animate-[spin_30s_linear_infinite]">
                {/* Outer circle */}
            ...
            {/* Floating Icons */}
            <div className="absolute w-[300px] h-[300px] sm:w-[600px] sm:h-[600px] animate-[spin_30s_linear_infinite]">
              {/* Top Right - Community */}
              <div className="absolute top-[10%] right-[15%] w-8 h-8 sm:w-12 sm:h-12 bg-[#E57373] rounded-full flex items-center justify-center shadow-lg animate-[spin_30s_linear_infinite_reverse] hover:scale-110 transition-transform">
                <svg
              ...
              <div className="absolute top-[45%] right-[5%] w-8 h-8 sm:w-12 sm:h-12 bg-[#81C784] rounded-full flex items-center justify-center shadow-lg animate-[spin_30s_linear_infinite_reverse] hover:scale-110 transition-transform">
                <svg
                  className="w-4 h-4 sm:w-6 sm:h-6 text-white"
                  fill="currentColor"
                  viewBox="0 0 20 20"
              ...
              <div className="absolute bottom-[15%] left-[35%] w-8 h-8 sm:w-12 sm:h-12 bg-[#FFB74D] rounded-full flex items-center justify-center shadow-lg animate-[spin_30s_linear_infinite_reverse] hover:scale-110 transition-transform">
                <svg
                  className="w-4 h-4 sm:w-6 sm:h-6 text-white"
                  fill="currentColor"
                  viewBox="0 0 20 20"
              ...
              <div className="absolute top-[35%] left-[5%] w-8 h-8 sm:w-12 sm:h-12 bg-[#FF9800] rounded-full flex items-center justify-center shadow-lg animate-[spin_30s_linear_infinite_reverse] hover:scale-110 transition-transform">
                <svg
                  className="w-4 h-4 sm:w-6 sm:h-6 text-white"
                  fill="currentColor"
                  viewBox="0 0 20 20"
            ...
            <div className="relative z-10 animate-float">
              <Image
                ...
                width={300}
                height={375}
                className="w-[250px] h-[312px] drop-shadow-2xl sm:w-[400px] sm:h-[500px]"
              />
            </div>
          </div>
        </ScrollAnimationWrapper>
