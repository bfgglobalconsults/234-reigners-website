    ...
    <section className="relative py-20 bg-[#FAF8F5]">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl text-black font-serif mb-4">How We Bring</h2>
        ...
        {/* Central Visual */}
        <div className="relative flex justify-center items-center mb-20 min-h-[500px]">
        ...
        <div className="text-center mb-12">
          <h3 className="text-3xl md:text-4xl text-black font-serif mb-4">One ecosystem.</h3>
          <h3 className="text-3xl md:text-4xl text-black font-serif mb-6">Infinite experiences.</h3>
          <div className="flex justify-center">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          <div className="bg-[#FFF4E6] p-6 rounded-lg">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-lg text-[#F47F2F] font-semibold mb-2">Cultural Experiences</h4>
          ...
          <div className="bg-[#FCE4EC] p-6 rounded-lg">
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-lg text-[#E45F6D] font-semibold mb-2">Community Engagement</h4>
                <p className="text-gray-600 text-sm">
          ...
          <div className="bg-[#FFF9E6] p-6 rounded-lg">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-[#FFB74D] rounded-lg flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
                    d="M4 4a2 2 0 012-2h8a2 2 0 012 2v12a1 1 0 110 2h-3a1 1 0 01-1-1v-2a1 1 0 00-1-1H9a1 1 0 00-1 1v2a1 1 0 01-1 1H4a1 1 0 110-2V4zm3 1h2v2H7V5zm2 4H7v2h2V9zm2-4h2v2h-2V5zm2 4h-2v2h2V9z"
              ...
              <div>
                <h4 className="text-lg text-[#D0982A] font-semibold mb-2">Physical Hubs</h4>
                <p className="text-gray-600 text-sm">
          ...
          <div className="bg-[#E8F5E9] p-6 rounded-lg">
            <div className="flex items-start gap-4">
              <div className="w-10 h-10 bg-[#81C784] rounded-lg flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 20 20">
                  <path d="M3 4a1 1 0 011-1h12a1 1 0 011 1v2a1 1 0 01-1 1H4a1 1 0 01-1-1V4zM3 10a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H4a1 1 0 01-1-1v-6zM14 9a1 1 0 00-1 1v6a1 1 0 001 1h2a1 1 0 001-1v-6a1 1 0 00-1-1h-2z" />
                </svg>
              </div>
              <div>
                <h4 className="text-lg text-[#58BD62] font-semibold mb-2">Digital Platform</h4>
                <p className="text-gray-600 text-sm">
