    ...
    <section className="py-20 bg-cream relative">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-12 gap-4">
          ...
          >
            <div className="relative h-[190px] md:h-[240px] rounded-3xl overflow-hidden group cursor-pointer">
              <Image
                src={memories[1]}
                alt="Memory 2"
                fill
          ...
          <ScrollAnimationWrapper
            ...
            className="col-span-6 md:col-span-3"
          >
            <div className="relative h-[190px] md:h-[240px] rounded-3xl overflow-hidden group cursor-pointer grayscale hover:grayscale-0 transition duration-500">
              <Image
                src={memories[4]}
                alt="Memory 5"
                fill
