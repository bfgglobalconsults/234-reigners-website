        ...
        <ScrollAnimationWrapper animation="fadeIn">
          <div className="flex flex-col md:flex-row justify-between items-start gap-6 mb-8 sm:mb-12">
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl md:text-5xl font-serif text-gold">
                your spirit.
              </h2>
            </div>
            <div className="text-left md:text-right max-w-xs">
              <p className="text-gray-600 text-xs sm:text-sm">
                From the table to the stage -- discover experiences across every dimension of
                culture.
              </p>
            </div>
          </div>
          ...
          <ScrollAnimationWrapper animation="fadeInRight" delay={100}>
            ...
            <div className="bg-[#58BD621A] rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Meet-ups, cultural forums, networking socials and gatherings where real
          ...
          <ScrollAnimationWrapper animation="fadeInRight" delay={200}>
            ...
            <div className="bg-[#F47F2F1A] rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition group">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 text-sm mb-4">
                  Pop-up dinners, street food markets, chef tables and tasting tours that turn
                  eating into an experience.
                </p>
                <a
                  href="#"
