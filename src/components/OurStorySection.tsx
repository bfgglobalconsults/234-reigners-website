        ...
        <div className="grid md:grid-cols-2 gap-12 items-start">
            ...
            <div className="absolute top-8 left-8 bg-white rounded-2xl p-6 shadow-lg">
              <div className="flex items-center gap-3 mb-2">
                <div className="w-8 h-8 relative">
                  <Image src="/assets/globe-icon.png" alt="Globe" fill className="object-contain" />
                </div>
          ...
          <div>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              234Reigners started with a simple feeling: that the richest experiences in life happen
              when people come together around culture — food, music, art, and belonging.
            </p>
            ...
            <p className="text-gray-700 mb-4 leading-relaxed">
              ...
              struggling to find real community. We also saw how hard it was to discover meaningful
              cultural experiences, let alone actually get there.
            </p>

            <p className="text-gray-700 mb-6 leading-relaxed">
              234Reigners is an intercultural community platform built to bridge that gap — helping
              people move from isolation to connection through shared experiences rooted in culture.
              By making it easy to discover events, hold your spot, and show up, the platform helps
              combat loneliness and creates moments of belonging that support emotional wellbeing.
            </p>

            <p className="text-gray-700 mb-8 leading-relaxed">
              We are community-first, using technology as a quiet tool — to surface the events worth
              your time, make participation effortless, and ensure you never miss the moments that
              matter.
            </p>
